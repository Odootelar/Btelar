...
class AccountMove(models.Model):
    ...
    def _post(self, soft=True):
        ...
        print('estoy aqui')
        if not self.env.su and (not self.env.user.has_group('account.group_account_invoice') and not self.env.user.has_group('inbest_security_rules.group_account_bill_collector')):
